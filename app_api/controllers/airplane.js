...
module.exports.climbDataReadAll = function(req, res) {
    ...
    ClimbData
        .find({})
        //This will tell exec to go with the function now
...
module.exports.landingDataReadOne = function(req, res) {
    ...
    if (req.params && req.params.weight && req.params.flaps) {
        ...
        Promise.all([minWeight, maxWeight, closestBelow, closestAbove]) //This will check if there are 'minWeight, maxWeight, closestBelow, closestAbove' as promised
